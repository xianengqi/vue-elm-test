...
export default {
  ...
  methods: {
    ...
    // 监听父极传来的数据发生变化时，触发此函数重新根据属性值获取数据
  ...
  watch: {
    // 监听父极传来的restaurantCategoryIds,当值发生变化的时候重新获取餐馆数据，作用于排序和率选
    ...
    // 监听父极的确认按钮是否被点击，并且返回一个自定义事件通知父级，已经接收到数据，此时父级才可以清除已选状态
